...
all: $(LOG_DIR) $(STORAGE_DIR) common tests main
	...
	@echo "  make run-ss       - Run Storage Server (default ports)"
	@echo "  make run-client   - Run Client"
	@echo "  make logs-main    - View main program logs"
	@echo ""
	@echo "To run multiple storage servers with custom ports:"
	@echo "  Terminal 1: make run-ss"
	@echo "  Terminal 2: ./storage_server/storage_server 192.168.1.187 9081 9082"
	@echo "  Terminal 3: ./storage_server/storage_server 192.168.1.187 10081 10082"
